...
@section('content')
	<div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
			...
			<a href="{!! url('/bank/form') !!}" class="btn btn-primary btn-rounded pull-right m-l-20 btn-sm  hidden-xs hidden-sm waves-effect waves-light"><i class="fa fa-pencil"></i> {!! Lang::get('app.create') !!}</a>
			@endif
			{!! Form::open(['url' => '/bank','method'=>'GET','class'=>'form-inline pull-right']) !!}
				...
				<table class="table">
					<thead>
						<tr>
							...
							<th class="col-md-3">@sortablelink('country_id', Lang::get('app.country'))</th>
								...
								<td class="text-center">
									<div class="btn-group dropup m-r-10">
										...
										<ul class="dropdown-menu">
											<li><a href="{!! url('/bank/view/'.Crypt::encrypt($row->id)) !!}"> {!! Lang::get('app.view') !!}</a></li>
											@if(Role::access('u','bank'))
											<li><a href="{!! url('/bank/form/'.Crypt::encrypt($row->id)) !!}"> {!! Lang::get('app.edit') !!}</a></li>
											@endif
											@if(Role::access('d','bank'))
												@if($row->id != 1)
