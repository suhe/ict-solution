...
@section('content')
	{!! Form::open(['url' => '/payment-method/do-update','role' => 'form','id'=>'update_form','class' => 'form-material form-horizontal']) !!}
	...
	<div class="row">
		<div class="col-lg-6">
			<div class="white-box">
				...
				<div class="form-group">
                    <label class="col-md-12">{!! Lang::get('app.type') !!} <span class="help"> *</span></label>
                    <div class="col-md-12">
						{!! Form::select('type',['Cash'=>'Cash','Non-Cash'=>'Non-Cash'],isset($data)?$data->type:null, ['class' => 'form-control form-control-line input-md','id'=>'type']) !!}
                    </div>
                </div>
