...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 26, 2016 at 04:34 PM
...
CREATE TABLE `companies` (
  ...
  `fax_number` varchar(28) DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `created_by` int(11) NOT NULL,
  `updated_at` datetime DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL
...
INSERT INTO `companies` (`id`, `name`, `npwp`, `address_1`, `address_2`, `city_id`, `zip_code`, `phone_number`, `fax_number`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(1, 'PT ANGKASA PURA SOLUSI', '01.071.557.1 - 058.000', 'Terminal 2F Kedatangan; Ruang F9P67', 'Bandara Internasional Soekarno-Hatta', 1, '19120', '+6221 550 5117', '+6221 55 910 912', '2016-12-22 04:00:00', 1, '2016-12-22 13:26:26', 1);
...
INSERT INTO `customers` (`id`, `identity_number`, `name`, `customer_group_id`, `contact_person`, `contact_position`, `phone_number`, `address`, `building_address`, `city_id`, `zip_code`, `is_active`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(1, 'IP00000001', 'PT. BANK RAKYAT INDONESIA (PERSERO), TBK.', 1, 'NIZAR ALAMSYAH', 'Se', '08522205405', 'KANTOR KAS BANK BRI KNO', 'GARUDA COMPUTER CENTER BUILDING, 2nd FLOOR', 1, '12059', 1, '2016-12-07 09:00:00', 1, '2016-12-26 15:26:04', 1),
(3, '12095', 'Asia Pacific', 1, 'banddd', 'jalsa', '08522205405', 'sdadasd', NULL, 1, '23232', 1, '2016-12-21 09:12:10', NULL, NULL, NULL);
...
CREATE TABLE `telephone_billings` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0=Draft,1=Process,2=Closed,3=Reject',
...
INSERT INTO `telephone_billings` (`id`, `number`, `customer_id`, `status`, `payment_method_id`, `payment_frequency`, `print_date`, `due_date`, `service_period`, `abodemen`, `japati`, `mobile`, `local`, `sljj`, `sli_007`, `telkom_global_017`, `surcharge`, `surcharge_total`, `ppn`, `ppn_total`, `total_bill`, `total_payment`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(8, '/APS-FIN/ICT-TLP/XII/2016/0000001', 1, 1, 1, 'BULANAN', '2016-12-22', '2016-12-24', '31 Des 2014', 240000, 40000, 0, 0, 0, 0, 0, 15, 6000, 10, 28600, 314600, 30000, '2016-12-24 03:07:41', 1, '2016-12-25 15:25:46', 1);
...
(15, 8, '0852205405855', '24 Okt 2014', 240000, 40000, 0, 0, 0, 0, 0, 15, 6000, 10, 28600, 314600);

-- --------------------------------------------------------

--
-- Table structure for table `telephone_billing_payments`
--

CREATE TABLE `telephone_billing_payments` (
  `id` int(11) NOT NULL,
  `telephone_billing_id` int(11) NOT NULL,
  `date` date NOT NULL,
  `payment_method_id` int(11) NOT NULL,
...
--
-- Dumping data for table `telephone_billing_payments`
--

INSERT INTO `telephone_billing_payments` (`id`, `telephone_billing_id`, `date`, `payment_method_id`, `bank_account_id`, `description`, `total`, `created_at`, `created_by`) VALUES
(5, 8, '2016-12-22', 1, 0, 'test', 30000, '2016-12-26 05:28:42', 1);
...
--
-- Indexes for table `telephone_billing_payments`
--
ALTER TABLE `telephone_billing_payments`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `telephone_billing_payments`
--
ALTER TABLE `telephone_billing_payments`
