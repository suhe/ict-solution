    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
          ...
          <div class="notify"><span class="heartbit"></span><span class="point"></span></div>
                    ...
                    <!-- /.dropdown -->
                    <li class="dropdown">
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src="{!! Theme::asset('img/varun.jpg') !!}" alt="user-img" width="36" class="img-circle"><b class="hidden-xs">{!! Auth::user()->first_name !!}</b> </a>
