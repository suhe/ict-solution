    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
          ...
          <div class="notify"><span class="heartbit"></span><span class="point"></span></div>
                    ...
                    <!-- /.dropdown -->
                    <li class="dropdown">
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src="{!! Theme::asset('img/varun.jpg') !!}" alt="user-img" width="36" class="img-circle"><b class="hidden-xs">Steave</b> </a>
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li> <a href="#" class="waves-effect"><i data-icon="&#xe00b;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">{!! Lang::get('app.crm')!!}<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="{!! url('/customer-group') !!}">{!! Lang::get('app.business partner')!!}</a></li>
                        </ul>
                    </li>
                    ...
                    <li> <a href="javascript:void(0)" class="waves-effect"><i data-icon="F" class="linea-icon linea-software fa-fw"></i> <span class="hide-menu">{!! Lang::get('app.settings')!!}<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            <li> <a href="javascript:void(0)">{!! Lang::get('app.my profile')!!}</a> </li>
                            ...
                            <li> <a href="javascript:void(0)" class="waves-effect">{!! Lang::get('app.user & group')!!} <span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    ...
                                    <li> <a href="javascript:void(0)">{!! Lang::get('app.group')!!}</a> </li>
                                </ul>
                            </li>
                        </ul>
                    </li>
